...
#     print(f'number of hybrid matches : {len(matches)}')
    ...
    if superpoint_matches.shape[0] <= temp_num_matches:
        ...
        print(f'Number of sparse matches used : {superpoint_matches.shape[0]}')
    else:
        ...
        print(f'Number of sparse matches used : {temp_num_matches}')
    ...
    if matches.shape[0] != num_matches:
        choice = crop_or_pad_choice(matches.shape[0], num_matches, shuffle=True)

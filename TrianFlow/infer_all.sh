...
do
    ...
    python infer_vo.py --config_file ./config/odo.yaml --gpu 0 --sequence $VARIABLE --traj_save_dir_txt /jbk001-data1/kitti/vo_preds/$VARIABLE.txt --sequences_root_dir /jbk001-data1/kitti/vo_dataset/sequences/ --pretrained_model ./models/pretrained/kitti_odo.pth  

    ...
    ** note: the input, output is different from that of SuperPointFrontend
    ...
    def __init__(self, config, save_path=Path("."), device="cpu", verbose=False):
        ...
        if self.config["model"]["dense_loss"]["enable"]:
            ...
            from superpoint.utils.utils import descriptor_loss
    ...
    def train_val_sample(self, sample, n_iter=0, train=False):
        ...
        # detector loss
        from superpoint.utils.utils import labels2Dto3D
        ...
        if n_iter % tb_interval == 0 or task == "val":
            ...
            def update_overlap(
                ...
                # image overlap
                from superpoint.utils.draw import img_overlap
    ...
    def flatten_64to1(semi, cell_size=8):
        ...
        """
        from superpoint.utils.d2s import DepthToSpace
...
if __name__ == "__main__":
    ...
    from superpoint.utils.loader import dataLoader as dataLoader
